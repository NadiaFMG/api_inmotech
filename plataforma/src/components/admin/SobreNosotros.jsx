              ...
              <Form.Group className="mb-3">
                ...
                <Form.Control
                  ...
                  onChange={async e => {
                    ...
                    if (file) {
                      await handleImageUpload(file, url => setForm(f => ({ ...f, imagen_url: url })));
                    }
                  }}
                />
                {form.imagen_url && (
            ...
            <Form.Group className="mb-3">
              ...
              <Form.Control
                ...
                onChange={async e => {
                  const file = e.target.files[0];
                  if (file) {
                    await handleImageUpload(file, url => setCreateForm(f => ({ ...f, imagen_url: url })));
                  }
                }}
              />
...
//arregla lo de la imagen previa que sale roto