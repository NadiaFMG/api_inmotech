// // // // src/components/profile/CrearPerfil.jsx
...
// // // const CrearPerfil = ({ userId, onSuccess, onCancel }) => {
...
// // //     setError('');
// // //     try {
// // //       await platformProfileService.create({
// // //         ...form,
...
// // //   return (
// // //     <div className="crear-perfil-card">
// // //       <h3>Crear Perfil</h3>
// // //       <form onSubmit={handleSubmit}>
// // //         <div className="crear-perfil-grid">
// // //           <div><label>Nombre</label><input name="Profile_name" value={form.Profile_name} onChange={handleChange} required /></div>
// // //           <div><label>Apellido</label><input name="Profile_lastname" value={form.Profile_lastname} onChange={handleChange} required /></div>
// // //           <div><label>Teléfono</label><input name="Profile_phone" value={form.Profile_phone} onChange={handleChange} /></div>
// // //           <div><label>Dirección</label><input name="Profile_addres" value={form.Profile_addres} onChange={handleChange} /></div>
// // //           <div><label>Correo</label><input name="Profile_email" value={form.Profile_email} onChange={handleChange} type="email" required /></div>
// // //           <div><label>Foto (URL)</label><input name="Profile_photo" value={form.Profile_photo} onChange={handleChange} /></div>
// // //           <div><label>Fecha de nacimiento</label><input name="Profile_birthdate" value={form.Profile_birthdate} onChange={handleChange} type="date" /></div>
// // //           <div><label>Género</label><input name="Profile_gender" value={form.Profile_gender} onChange={handleChange} /></div>
// // //           <div><label>Documento</label><input name="Profile_national_id" value={form.Profile_national_id} onChange={handleChange} /></div>
// // //           <div><label>Biografía</label><textarea name="Profile_bio" value={form.Profile_bio} onChange={handleChange} /></div>
// // //           <div><label>Sitio web</label><input name="Profile_website" value={form.Profile_website} onChange={handleChange} /></div>
// // //           <div><label>Red social</label><input name="Profile_social" value={form.Profile_social} onChange={handleChange} /></div>
// // //         </div>
// // //         {error && <div className="crear-perfil-error">{error}</div>}
// // //         <div className="crear-perfil-actions">
...
// //       <h2 className="crear-perfil-title">Crear Perfil</h2>
// //       <form onSubmit={handleSubmit}>
...
//   // Si perfil existe, inicializa el formulario con sus datos
//   useEffect(() => {
//     if (perfil) {
//       setForm({
...
//       if (perfil) {
//         // Editar perfil
//         await platformProfileService.update(perfil.Profile_id, {
//           ...form,
//           Platform_user_FK: userId
//         });
//       } else {
