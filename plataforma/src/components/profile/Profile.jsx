...
// //       return;
// //     }
// //     // Usar el nuevo servicio para obtener el perfil por username o email
// //     platformProfileService
// //       .getByUser({ username: user.Username, email: user.email })
// //       .then(res => {
...
//   const user = JSON.parse(localStorage.getItem('user'));
//   const userId = user?.id || user?.Platform_user_id;
...
//       return;
//     }
//     console.log('userId usado para buscar perfil:', userId); // <-- AQUÍ
//     // Usar el servicio para obtener el perfil por userId
//     platformProfileService
//       .getByUserId(userId)
//       .then(res => {
//         setPerfil(res.data || null);
