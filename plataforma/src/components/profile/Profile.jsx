...
// // //       <div className="perfil-actions" style={{ display: 'flex', gap: '18px', justifyContent: 'center', marginTop: '18px' }}>
// // //         <button className="perfil-btn editar" onClick={handleEditarPerfil}>
// // //           {perfil ? 'Editar Perfil' : 'Crear Perfil'}
// // //         </button>
// // //         <button className="perfil-btn cerrar" onClick={handleCerrarSesion}>
// // //           Cerrar Sesión
// // //         </button>
// // //       </div>
...
// // //         </div>
// // //       </div>
// // //       {/* Modal para editar/crear perfil */}
// // //       {showEditar && (
