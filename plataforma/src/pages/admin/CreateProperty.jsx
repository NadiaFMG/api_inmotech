...
//   // Manejo de campos anidados de segundo nivel
...
//     // Aquí deberías subir cada archivo a tu backend o servicio de almacenamiento
//     // y obtener la URL pública de cada imagen.
//     // Este ejemplo simula la subida y genera URLs locales:
//     const nuevasImagenes = await Promise.all(files.map(async (file) => {
//         // Simulación: usa URL.createObjectURL para vista previa local
//         // Reemplaza esto por la lógica real de subida y obtención de URL
...
//     const handleImagenChange = (idx, e) => {
//         const { name, value } = e.target;
//         setProperty(prev => {
//         const newImgs = [...prev.imagenes_inmueble];
//         newImgs[idx][name] = value;
//         return { ...prev, imagenes_inmueble: newImgs };
//         });
//     };
...
//     setProperty(prev => ({
//       ...prev,
//       imagenes_inmueble: [...prev.imagenes_inmueble, { Imagenes: '', Nombre: '', URL: '' }]
//     }));
//   };
...
//               <Form.Control type="text" name="Nombre" value={img.Nombre} onChange={e => handleImagenChange(idx, e)} required />
//             </Form.Group>
//             <Form.Group>
//               <Form.Label>URL</Form.Label>
//               <Form.Control type="text" name="URL" value={img.URL} onChange={e => handleImagenChange(idx, e)} required />
//             </Form.Group>
//             <Form.Group>
//               <Form.Label>Archivo Imagen</Form.Label>
//               <Form.Control type="text" name="Imagenes" value={img.Imagenes} onChange={e => handleImagenChange(idx, e)} required />
//             </Form.Group>
//           </div>
//         ))} */}
...
//                 name="Nombre"
//                 value={img.Nombre}
//                 onChange={e => handleImagenChange(idx, e)}
//                 required
//             />
//             </Form.Group>
//             <Form.Group>
