...
const VenderInmueble = () => {
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      const payload = {
        ...
        Platform_user_FK: Number(user?.id) || 1, // Usar ID del usuario o 1 por defecto
      ...
      navigate('/inmuebles'); // Cambiar a /inmuebles para ver el resultado
    } catch (error) {
  ...
  return (
    <Container className="mt-4">
      <h2 className='admin-dashboard-titulo text-center mb-4'>Vender Inmueble</h2>
